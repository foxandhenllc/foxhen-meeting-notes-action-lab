# Contributing to Meeting Notes Action Lab

Meeting Notes Action Lab is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A meeting-notes lab for extracting decisions, owners, blockers, due dates, and follow-up summaries from fictional notes.
